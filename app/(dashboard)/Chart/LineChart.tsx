...
// console.log('Filled Fact Check Data:', filledFactCheckData);
    ...
    if(value == filledFactCheckData?.year && value2 == 13){
      ...
      if(filledFactCheckData){
        ...
        ApprovedList = sortedByDay.map((dayData: any) => dayData.statistic.total_approved !== 0
        ...
        : 0)
        RefusedList = sortedByDay.map((dayData: any) => dayData.statistic.total_refuted !== 0
        ...
        : 0)
        NeutralList = sortedByDay.map((dayData: any) => dayData.statistic.total_neutral !== 0
